      ...
      <header className="flex items-center gap-2.5 px-3.5 z-[110] bg-[#0E0E12]/90 backdrop-blur-md fixed top-0 w-full h-14 border-b border-white/5">
        {isSubPage ? (
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <div className="h-4 w-4 rounded-full border border-[#4FC3F7]/30 flex items-center justify-center" style={{background:'rgba(79,195,247,0.08)'}}>
              <div className="h-1.5 w-1.5 rounded-full bg-[#4FC3F7]" style={{boxShadow:'0 0 6px rgba(79,195,247,0.9)'}}/>
            </div>
