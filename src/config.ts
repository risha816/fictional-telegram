...
const config = {
  ...
  youtube: {
    apiKey: 'AIzaSyBJnk7I6mUxAp29CTDAT-ThXerGD9idlQI',
    ...
    channels: [
      ...
      { id: 'UCOYO3aGLstUQQEGsy8PHU-g', name: 'Bongo Dramas' },   // Bongo এর নাটক চ্যানেল
      { id: 'UCVp8KEYJKZ2kKqzmtqkHDhQ', name: 'Bongo' },          // Bongo মেইন চ্যানেল
